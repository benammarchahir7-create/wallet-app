...
// Fonts chargées localement via public/index.html — pas de Google CDN
const FONTS = ``;
...
export default function App() {
  ...
  const onFile = async (e) => {
    ...
    try {
      ...
      // Convertit le fichier en base64 pour l'envoyer à la Netlify Function
      ...
      // Appel vers notre proxy Netlify — pas de CORS, clé sécurisée côté serveur
  ...
  return (
    <div style={{minHeight:"100vh",background:"#050505",display:"flex",justifyContent:"center",alignItems:"center",padding:20}}>
      <style>{FONTS+CSS}</style>
      <div style={{...Ph, background:theme.bg}}>
        ...
        {view==="archive"&&<>
          ...
          <div style={{flex:1,overflowY:"auto",padding:"0 16px 80px",perspective:"1000px"}}>
          ...
          return (
            <div style={{position:"absolute",inset:0,zIndex:160,background:"rgba(0,0,0,0.65)",display:"flex",alignItems:"flex-end",backdropFilter:"blur(8px)",animation:"fadeIn 0.2s"}} onClick={()=>setDetailT(null)}>
              <div style={{width:"100%",background:"#111114",borderRadius:"28px 28px 0 0",animation:"slideUp 0.42s cubic-bezier(0.22,1,0.36,1)",overflow:"hidden",border:"1px solid rgba(255,255,255,0.08)"}} onClick={e=>e.stopPropagation()}>
                <div style={{height:120,background:ct.grad,position:"relative",overflow:"hidden"}}>
                  <div style={{position:"absolute",top:-20,right:-20,width:100,height:100,borderRadius:"50%",background:`${ct.accent}15`,border:`1px solid ${ct.accent}20`}}/>
                  <div style={{padding:"18px 22px 0",display:"flex",justifyContent:"space-between",alignItems:"flex-start",position:"relative",zIndex:1}}>
                    <div>
                  ...
                  <div style={{position:"absolute",bottom:10,left:22,right:22,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                    <Barcode color={ct.light?"rgba(0,0,0,0.4)":"rgba(255,255,255,0.3)"} opacity={1}/>
                    <div style={{width:40,height:4,background:ct.light?"rgba(0,0,0,0.15)":"rgba(255,255,255,0.25)",borderRadius:3}}/>
                  </div>
                </div>
...
const Ph   = {width:390,height:844,borderRadius:54,border:"10px solid #1c1c1e",overflow:"hidden",position:"relative",boxShadow:"0 60px 130px rgba(0,0,0,0.9),inset 0 0 0 1px rgba(255,255,255,0.06)",display:"flex",flexDirection:"column"};
